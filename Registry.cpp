...
DWORD Registry::RegGetDword(HKEY hKey, const wstring& subKey, const wstring& value)
{
	DWORD data{};
...
wstring Registry::RegGetString(HKEY hKey, const wstring& subKey, const wstring& value)
{
	DWORD dataSize{};
	LONG retCode = RegGetValue(
		hKey,
...
vector<wstring> Registry::RegGetMultiString(HKEY hKey, const wstring& subKey, const wstring& value)
{
	DWORD dataSize{};
	LONG retCode = RegGetValue(
		hKey,
